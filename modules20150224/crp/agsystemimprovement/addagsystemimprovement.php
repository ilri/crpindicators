...
<div class='main'>
<form class="forms" id="theform" action="addagsystemimprovement_proc.php" name="agsystemimprovement" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Men Beneficiaries : </td>
		<td><input type="text" name="beneficiaries" id="beneficiaries" value="<?php echo $obj->beneficiaries; ?>"></td>
	</tr>
	<tr>
		<td align="right">Women Beneficiaries : </td>
