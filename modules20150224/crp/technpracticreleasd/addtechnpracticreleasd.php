...
<div class='main'>
<form class="forms" id="theform" action="addtechnpracticreleasd_proc.php" name="technpracticreleasd" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right" width="50%">Enter the name of technology/NRM practise released by public and private sector globally by CRP 3.7 in 2013: </td>
		<td><textarea name="practice_name" id="practice_name"><?php echo $obj->practice_name; ?></textarea></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="partners" id="partners" value="<?php echo $obj->partners; ?>"></td>
	</tr>
	<tr>
		<td align="right"> </td>
