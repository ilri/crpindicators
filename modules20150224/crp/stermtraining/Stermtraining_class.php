<?php 
require_once("StermtrainingDBO.php");
class Stermtraining
{				
	var $id;			
	var $short_training_name;			
	var $location;			
	var $men_number;			
	var $women_number;			
	var $crpid;
	...
	function setObject($obj){
		...
		$this->short_training_name=str_replace("'","\'",$obj->short_training_name);
		$this->location=str_replace("'","\'",$obj->location);
		$this->men_number=str_replace("'","\'",$obj->men_number);
		$this->women_number=str_replace("'","\'",$obj->women_number);
		if(empty($obj->crpid))
			$obj->crpid='NULL';
	...
	//get short_training_name
	function getShort_training_name(){
		return $this->short_training_name;
	}
	//set short_training_name
	function setShort_training_name($short_training_name){
		$this->short_training_name=$short_training_name;
	}
	...
	//get men_number
	function getMen_number(){
		return $this->men_number;
	}
	//set men_number
	function setMen_number($men_number){
		$this->men_number=$men_number;
	}

	//get women_number
	function getWomen_number(){
		return $this->women_number;
	}
	//set women_number
	function setWomen_number($women_number){
		$this->women_number=$women_number;
	}
	...
	function add($obj){
		$stermtrainingDBO = new StermtrainingDBO();
		if($stermtrainingDBO->persist($obj)){
// 			$this->id=$stermtrainingDBO->id;
// 			$this->sql=$stermtrainingDBO->sql;


			$valueid=$stermtrainingDBO->id;

			$tables = new Tables();
			$tableid = $tables->getTable("stermtraining");
	...
	function edit($obj,$where=""){
		$stermtrainingDBO = new StermtrainingDBO();
		if($stermtrainingDBO->update($obj,$where)){
			$valueid=$obj->id;
	...
	function delete($obj,$where=""){			
		$stermtrainingDBO = new StermtrainingDBO();
		if($stermtrainingDBO->delete($obj,$where=""))		
			$this->sql=$stermtrainingDBO->sql;
			return true;	
	}			
	function retrieve($fields,$join,$where,$having,$groupby,$orderby){			
		$stermtrainingDBO = new StermtrainingDBO();
		$this->table=$stermtrainingDBO->table;
		$stermtrainingDBO->retrieve($fields,$join,$where,$having,$groupby,$orderby);		
		$this->sql=$stermtrainingDBO->sql;
		$this->result=$stermtrainingDBO->result;
		$this->fetchObject=$stermtrainingDBO->fetchObject;
		$this->affectedRows=$stermtrainingDBO->affectedRows;
	}			
