<?php 
require_once("TechfieldtestedDBO.php");
class Techfieldtested
{				
	var $id;			
	var $practise_name;			
	var $geog_location;
	...
	function add($obj){
		$techfieldtestedDBO = new TechfieldtestedDBO();
		if($techfieldtestedDBO->persist($obj)){
// 			$this->id=$techfieldtestedDBO->id;
// 			$this->sql=$techfieldtestedDBO->sql;

			$valueid=$techfieldtestedDBO->id;

			$tables = new Tables();
			$tableid = $tables->getTable("techfieldtested");
	...
	function edit($obj,$where=""){
		$techfieldtestedDBO = new TechfieldtestedDBO();
		if($techfieldtestedDBO->update($obj,$where)){
			$valueid=$obj->id;
	...
	function delete($obj,$where=""){			
		$techfieldtestedDBO = new TechfieldtestedDBO();
		if($techfieldtestedDBO->delete($obj,$where=""))		
			$this->sql=$techfieldtestedDBO->sql;
			return true;	
	}			
	function retrieve($fields,$join,$where,$having,$groupby,$orderby){			
		$techfieldtestedDBO = new TechfieldtestedDBO();
		$this->table=$techfieldtestedDBO->table;
		$techfieldtestedDBO->retrieve($fields,$join,$where,$having,$groupby,$orderby);		
		$this->sql=$techfieldtestedDBO->sql;
		$this->result=$techfieldtestedDBO->result;
		$this->fetchObject=$techfieldtestedDBO->fetchObject;
		$this->affectedRows=$techfieldtestedDBO->affectedRows;
	}			
