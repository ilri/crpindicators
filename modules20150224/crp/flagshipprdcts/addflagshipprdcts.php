...
<div class='main'>
<form class="forms" id="theform" action="addflagshipprdcts_proc.php" name="flagshipprdcts" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right" width="50%">Enter the name of flagship product produced by CRP 3.7: </td>
		<td><textarea name="flagship_product_name" id="flagship_product_name"><?php echo $obj->flagship_product_name; ?></textarea></td>
	</tr>
	<tr>
		<td align="right">Does the flagship project produced have explicit target of women farmers /NRM managers? (Tick if Yes) : </td>
		<td><input type="checkbox" name="targeting_women" id="targeting_women" value="1" <?php if($obj->targeting_women==1){echo"checked";} ?>></td>
	</tr>
	<tr>
		<td align="right">Has the flagship produced been assessed for likely gender-disaggregated impact ?( Tick if Yes) : </td>
		<td><input type="checkbox" name="gender_disaggregated" id="gender_disaggregated" value="1" <?php if($obj->gender_disaggregated==1){echo"checked";} ?>></td>
	</tr>
	<tr>
		<td align="right">Enter URL : </td>
		<!--<td><input type="textarea" name="url" id="url" value="<?php echo $obj->url; ?>"></td>-->
...
<?php
	...
	if(!$obj->crpattribution){
	  ...
	  ?>
	   <tr>
	    <td align="right"><?php echo $row->crpno." ".$row->crp_name; ?></td>
