...
<div class='main'>
<form class="forms" id="theform" action="addagsystemfieldtestin_proc.php" name="agsystemfieldtestin" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="text" name="practice_name" id="practice_name" value="<?php echo $obj->practice_name; ?>"></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="right">Decrease Inequality : </td>
		<td><input type="checkbox" name="decrease_inequality" id="decrease_inequality" value="1" <?php if($obj->decrease_inequality==1){echo"checked";}?>></td>
	</tr>
	
	<tr>
		<td align="right">Number of Publications : </td>
		<td><input type="text" name="publications" id="publications" value="<?php echo $obj->publications; ?>"></td>
	</tr>
	<tr>
