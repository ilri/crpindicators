...
<div class='main'>
<form class="forms" id="theform" action="addstrategicvchainsanalysed_proc.php" name="strategicvchainsanalysed" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right" width="50%">Enter the name of the strategic value chain anaylzed by CRP 3.7 in 2013 : </td>
		<td><textarea name="value_chain_desc" id="value_chain_desc"><?php echo $obj->value_chain_desc; ?></textarea></td>
	</tr>
	<tr>
