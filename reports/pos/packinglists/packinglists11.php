...
$rptgroup='';
$track=0;
if(!empty($obj->grdocumentno) or !empty($obj->grorderno) or !empty($obj->grcustomerid) or !empty($obj->grpackedon) or !empty($obj->grfleetid) or !empty($obj->gremployeeid) or !empty($obj->grcreatedby) or !empty($obj->grcreatedon) ){
	$obj->shdocumentno='';
	$obj->shorderno='';
	$obj->shcustomerid='';
	$obj->shpackedon='';
