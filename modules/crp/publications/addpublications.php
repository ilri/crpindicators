...
<div class='main'>
<form class="forms" id="theform" action="addpublications_proc.php" name="publications" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right" width="50%">Name of the publication in ISI journals produced by CRP 3.7: </td>
		<td><textarea name="publication_name" id="publication_name"><?php echo $obj->publication_name; ?></textarea></td>
	</tr>
	<tr>
		<td align="right">Year of Publication : </td>
		<td><input type="text" name="publication_year" id="publication_year" value="<?php echo $obj->publication_year; ?>"></td>
	</tr>
	<tr>
		<td align="right">Authors : </td>
		<td><input type="text" name="authors" id="authors" value="<?php echo $obj->authors; ?>"></td>
	</tr>
	<tr>
		<td align="right">Journal Name : </td>
		<td><input type="text" name="journal_name" id="journal_name" value="<?php echo $obj->journal_name; ?>"></td>
	</tr>
	<tr>
		<td align="right">Enter URL( or Mahider handle) : </td>
