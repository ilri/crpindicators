...
<div class='main'>
<form class="forms" id="theform" action="addinnovationplatform_proc.php" name="innovationplatform" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right">Innovation Name : </td>
		<td><textarea name="innovation_name" id="innovation_name"><?php echo $obj->innovation_name; ?></textarea></td>
	</tr>
	<tr>
