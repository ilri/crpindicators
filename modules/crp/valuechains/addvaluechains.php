<title>CRP Indicators: Sub-Categorys </title>
<?php 
...
<div class='main'>
<form class="forms" id="theform" action="addvaluechains_proc.php" name="valuechains" method="POST" enctype="multipart/form-data">
