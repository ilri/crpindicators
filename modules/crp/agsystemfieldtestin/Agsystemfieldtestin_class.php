<?php 
require_once("AgsystemfieldtestinDBO.php");
class Agsystemfieldtestin
{				
	var $id;			
	var $ecosystem_name;			
	var $practice_name;			
	...
	function setObject($obj){
		...
		$this->decrease_inequality=str_replace("'","\'",$obj->decrease_inequality);
		$this->publications=str_replace("'","\'",$obj->publications);
	...
	//get decrease_inequality
	function getDecrease_inequality(){
		return $this->decrease_inequality;
	}
	//set decrease_inequality
	function setDecrease_inequality($decrease_inequality){
		$this->decrease_inequality=$decrease_inequality;
	}
	...
	function add($obj){
		$agsystemfieldtestinDBO = new AgsystemfieldtestinDBO();
		if($agsystemfieldtestinDBO->persist($obj)){
// 			$this->id=$agsystemfieldtestinDBO->id;
// 			$this->sql=$agsystemfieldtestinDBO->sql;

		      $valueid=$agsystemfieldtestinDBO->id;
	...
	function edit($obj,$where=""){
		$agsystemfieldtestinDBO = new AgsystemfieldtestinDBO();
		if($agsystemfieldtestinDBO->update($obj,$where)){
			//$this->sql=$agsystemfieldtestinDBO->sql;$valueid=$obj->id;
	...
	function delete($obj,$where=""){			
		$agsystemfieldtestinDBO = new AgsystemfieldtestinDBO();
		if($agsystemfieldtestinDBO->delete($obj,$where=""))		
			$this->sql=$agsystemfieldtestinDBO->sql;
			return true;	
	}			
	function retrieve($fields,$join,$where,$having,$groupby,$orderby){			
		$agsystemfieldtestinDBO = new AgsystemfieldtestinDBO();
		$this->table=$agsystemfieldtestinDBO->table;
		$agsystemfieldtestinDBO->retrieve($fields,$join,$where,$having,$groupby,$orderby);		
		$this->sql=$agsystemfieldtestinDBO->sql;
		$this->result=$agsystemfieldtestinDBO->result;
		$this->fetchObject=$agsystemfieldtestinDBO->fetchObject;
		$this->affectedRows=$agsystemfieldtestinDBO->affectedRows;
	}			
