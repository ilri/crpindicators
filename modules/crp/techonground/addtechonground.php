...
<div class='main'>
<form class="forms" id="theform" action="addtechonground_proc.php" name="techonground" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right" width="50%">Enter the name of the improved technology or management practice applied on the ground as a result of CRP 3.7 research  in 2013: </td>
	...
	<tr>
		<td align="right">Area covered in hectares : </td>
		<td><input type="text" name="area" id="area" value="<?php echo $obj->area; ?>"></td>
	</tr>
	<tr>
		<td align="right">Newarea : </td>
		<td><input type="text" name="newarea" id="newarea" value="<?php echo $obj->newarea; ?>"></td>
	</tr>
	
	<tr>
		<td align="right">Men Applying : </td>
		<td><input type="text" name="men" id="men" value="<?php echo $obj->men; ?>"></td>
	</tr>
	
	<tr>
		<td align="right">Women Applying : </td>
		<td><input type="text" name="women" id="women" value="<?php echo $obj->women; ?>"></td>
	</tr>
