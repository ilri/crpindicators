...
<form class="forms" id="theform" action="addperiods_proc.php" name="periods" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="checkbox" name="status" id="status" value="active" <?php if($obj->status=='active')echo "checked";?>/><font color='red'>*</font></td>
	</tr>
	<tr>
