...
<div class='main'>
<form class="forms" id="theform" action="addpubtargetinecosystems_proc.php" name="pubtargetinecosystems" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		...
		<td><input type="text" name="publication_name" id="publication_name" value="<?php echo $obj->publication_name; ?>"></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="right">Journal Mag Book : </td>
		<td><input type="text" name="journal_mag_book" id="journal_mag_book" value="<?php echo $obj->journal_mag_book; ?>"></td>
	</tr>
	<tr>
