...
<div class='main'>
<form class="forms" id="theform" action="addtoolsproduced_proc.php" name="toolsproduced" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right" width="50%">Name of tool produced by CRP 3.7 in 2013 : </td>
		<td><textarea name="tool_name" id="tool_name"><?php echo $obj->tool_name; ?></textarea></td>
	</tr>
	<tr>
		<td align="right">Does the tool have an explicit target of women farmers ?( Tick if Yes): </td>
		<td><input type="checkbox" name="targeting_women" id="targeting_women" value="1" <?php if($obj->targeting_women==1){echo"checked";} ?>></td>
	</tr>
	<tr>
		<td align="right">Has the tool been assessed for likely gender-disaggregated impact?(Tick if Yes) : </td>
