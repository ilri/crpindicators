...
<div class='main'>
<form class="forms" id="theform" action="addtechfieldtested_proc.php" name="techfieldtested" method="POST" enctype="multipart/form-data">
 ...
 <?php if(!empty($obj->retrieve)){?>
	...
	<tr>
		<td align="right" width="50%">Enter the name of the technology/NRM practise field tested by CRP 3.7: </td>
	...
	<tr>
		<td align="right">Geographical Location(s) : </td>
