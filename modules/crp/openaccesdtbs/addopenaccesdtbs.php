...
<div class='main'>
<form class="forms" id="theform" action="addopenaccesdtbs_proc.php" name="openaccesdtbs" method="POST" enctype="multipart/form-data">
	<table width="100%" class="titems gridd" border="0" align="center" cellpadding="2" cellspacing="0" id="tblSample">
 <?php if(!empty($obj->retrieve)){?>
	<tr>
		<td colspan="4" align="center"><input type="hidden" name="retrieve" value="<?php echo $obj->retrieve; ?>"/>Document No:<input type="textarea" size="4" name="invoiceno"/>&nbsp;<input type="submit" name="action" value="Filter"/></td>
	</tr>
	<?php }?>
	<tr>
	...
	<tr>
		<td align="right" width="50%">Enter name of open access database maintained : </td>
		<td><textarea name="database_name" id="database_name"><?php echo $obj->database_name; ?></textarea></td>
	</tr>
	<tr>
		<td align="right">Total number of users of this open database : </td>
		<td><input type="textarea" name="users" id="users" value="<?php echo $obj->users; ?>"></td>
	</tr>
	<tr>
